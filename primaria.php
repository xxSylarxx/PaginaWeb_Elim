...
@media only screen and (max-width:1399px){
    ...
    <section class="container">
        <div class="separador">
            ...
            <div class="sep_title">NIVEL PRIMARIA</div>
        </div>
        <div class="row justify-content-around mt-4 pt-4">
            <div class="col-lg-5 my-auto">
                
                <p class="text-justify line">
                    En este nivel, nuestros estudiantes desarrollan diferentes habilidades y capacidades en el pensamiento lógico y 
                    comprensión lectora asi como una enseñanza lúdica y creativa, buscamos desarrollar en nuestros alumnos el conocimiento,
                     trabajo en equipo y un rol protagónico en su enseñanza formando asi estudiantes de manera integral, nuestros estudiantes
                      logran el desarrollo progresivo de sus capacidades con base en técnicas de innovación permanente. Potenciamos el talento 
                      de una manera integral y desarrollamos competencias para que se desenvuelvan en entornos virtuales generados por las nuevas 
                      tecnologías con el uso de herramientas interactivas como liveworkshets, canva, genially, etc.
                </p>
            ...
            <div class="col-lg-6 my-auto ">
                    ...
                    <div class="carousel-inner">
                          <div class="carousel-item active">
                           <img src="./assets/img/primaria/primaria1.jpg" class="imgnivel d-block w-100"  alt="...">
                          </div>
                      <div class="carousel-item">
                             <img src="./assets/img/primaria/primaria2.jpg" class=" imgnivel d-block w-100"   alt="...">
                         </div>
                     <div class="carousel-item">
                              <img src="./assets/img/primaria/primaria3.jpg" class="imgnivel d-block w-100"  alt="...">
                    </div>
                    </div>
