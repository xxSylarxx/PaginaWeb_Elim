...
@media only screen and (max-width:1399px){
    ...
    <section class="container">
        <div class="separador">
            ...
            <div class="sep_title">NIVEL INICIAL</div>
        </div>
        <div class="row justify-content-around mt-4 pt-4">
            <div class="col-lg-5 my-auto">
                
                <p class="text-justify line">
                    Buscamos que nuestros niños puedan construir sus propios aprendizajes y desarrollen de forma integral sus diferentes talentos e inteligencias múltiples a través de talleres prácticos como: minichef, teatro, coreografía, canto donde puedan fortalecer sus diferentes habilidades. En inicial también hacemos uso del tic dentro de nuestras áreas utilizando diferentes herramientas on line como quiziz, kahoot, Educaplay, etc, para que la enseñanza aprendizaje sea de manera divertida.
                </p>
            ...
            <div class="col-lg-6 my-auto ">
                    ...
                    <div class="carousel-inner">
                          ...
                          <img src="./assets/img/inicial/inicial2.jpg" class="imgnivel d-block w-100"  alt="...">
                           
                          </div>
                      <div class="carousel-item">
                             <img src="./assets/img/inicial/inicial1.jpg" class="imgnivel w-100"   alt="...">
                         </div>
                     <div class="carousel-item">
                         
                              <img src="./assets/img/inicial/inicial3.jpg" class="imgnivel d-block w-100" alt="...">
                    </div>
                    </div>
