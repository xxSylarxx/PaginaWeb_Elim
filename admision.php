...
@media only screen and (max-width:1399px){
    ...
    <section class="container">
        <div class="separador">
            ...
            <div class="sep_title">ADMISIÓN 2022</div>
        </div>
        <div class="row justify-content-around mt-4 pt-4">
        <iframe src="./assets/files/ADMISIÓN - ACTUALIZACIÓN DE DATOS 2022.pdf" class="shadow" frameborder="0" width="100%" height="900"></iframe>
        </div>
    </section>
    <br>
    <br>
