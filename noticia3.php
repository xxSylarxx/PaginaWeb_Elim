...
<div class="container">
    <div class="row">
        <div class="col-md">
            <h2 class="prim text-uppercase mb-3">El IDIOMA INGLÉS</h2>
            <p class="color-secu font-weight-bold"><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp; 2021-05-11</p>
            <hr>
            <div class="content p-2">
                <p style="text-align:justify">
                En Elim queremos que domines el idioma Inglés 🇬🇧🇺🇸 
                    Por eso, estudia con nosotros y vive la experiencia‼️</p>            
                               
            </div>
                <br>
            <div class="text-center">
            <iframe src="https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Felimcolegio%2Fvideos%2F4550151105039876&width=600&show_text=false&appId=543564153315944&height=330" width="80%" height="330" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowFullScreen="true"></iframe>
            </div>
        </div>
