...
@media only screen and (max-width:1399px){
    ...
    <section class="container">
        <div class="separador">
            ...
            <div class="sep_title">SISTEMA DE EVALUACIÓN</div>
        </div>
        <div class="row justify-content-around mt-4 pt-4">
        <iframe src="./assets/files/ANEXO 4 SISTEMA DE EVALUACIÓN DE LOS APRENDIZAJES Y CONTROL DE ASISTENCIA 2022.pdf" class="shadow" frameborder="0" width="100%" height="900"></iframe>
        </div>
    </section>
    <br>
    <br>
