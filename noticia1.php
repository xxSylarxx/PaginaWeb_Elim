...
<div class="container">
    <div class="row">
        <div class="col-md">
            <h2 class="prim text-uppercase mb-3">MATRÍCULA 2022 👩‍🎓</h2>
            <p class="color-secu font-weight-bold"><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp; 2021-05-11</p>
            <hr>
            <div class="content p-2">
                <p>
                             Nuestra pedagogía se basa en la educación cristiana y en el compromiso de guiar todas las actividades didácticas hacia la integración natural de la fe y la enseñanza.
                            Inscribe a tu hijo y bríndale la oportunidad de una educación con calidad.
                Contáctenos !!!</p>
            ...
            <iframe src="https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Felimcolegio%2Fvideos%2F3095618827384679&width=600&show_text=false&appId=543564153315944&height=338" width="80%" height="338" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowFullScreen="true"></iframe>
            </div>
        </div>
